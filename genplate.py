...
'''
Python3的改变:
原代码基于python2，python3没有xrange，无需为utf8作特殊处理
'''
...
class GenPlate:
    ...
    def genBatch(self, batchSize,pos,charRange, outputPath,size):
        ...
        for i in range(batchSize):
            ...
            cv2.imencode('.jpg', img)[1].tofile(filename) #保存图片到带有中文的路径正确的解决办法

G = GenPlate("./font/platech.ttf",'./font/platechar.ttf',"./NoPlates")

#G.genBatch(10000,2,range(31,65),"./plate_images/train",(272,72))
G.genBatch(1000,2,range(31,65),"./plate_images/val",(272,72))
